...
WORK_DIR="/nfs/ofs-902-1/object-detection/jiangjing/experiments/MM-DFN"
...
GCN_LAYERS="16" # [8 ,16, 32, 64]
LR="0.0001"     # [0.0001, 0.0003]
L2="0.0001"     # [0.0001 0.0005]
DP="0.2"        # [0.2 0.4]
GAMMA="0.5"     # [0.5 1]
SW="3-0-1"      # 3-0-1

for gcn_layers in ${GCN_LAYERS[@]}; do
  for lr in ${LR[@]}; do
    for l2 in ${L2[@]}; do
      for dropout in ${DP[@]}; do
        for gamma in ${GAMMA[@]}; do
          for speaker_weights in ${SW[@]}; do
